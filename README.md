        ...
        <div class="max-w-7xl mx-auto text-center">
            ...
            <div class="max-w-5xl mx-auto sketch-border bg-white p-8 md:p-12 flex flex-col md:flex-row items-center gap-12">
                ...
                <div class="w-full md:w-1/2 text-left p-8 border-4 border-indigo-600 bg-white relative">
                    ...
                    <div class="absolute -right-4 -bottom-4 bg-indigo-600 text-white px-3 py-1 text-[10px] font-black uppercase shadow-lg italic">KDP Approved</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <p class="text-slate-600 font-medium max-w-xs mb-6 italic">The gold standard in high-precision book formatting for the modern author.</p>
                    <div class="label-bold">Service Status: 100% Operational</div>
                </div>

                <!-- Navigation -->
                <div>
                    <h4 class="font-black uppercase text-indigo-950 mb-6 text-sm tracking-widest underline decoration-4 decoration-indigo-600 underline-offset-4">Quick Links</h4>
                    <ul class="space-y-3 font-bold text-slate-600 text-sm">
                        <!-- PREVIEW LINK -->
                        <li><a href="https://manuscriptpro.online" class="hover:text-indigo-600 transition-colors">Free Preview</a></li>
                        <!-- PAYMENT LINK -->
                        <li><a href="https://paystack.shop/pay/u6krvg7c2x" class="hover:text-indigo-600 transition-colors">Pricing & Checkout</a></li>
                        <li><a href="https://wa.me/2349155975173" class="hover:text-indigo-600 transition-colors">WhatsApp Support</a></li>
                    </ul>
                </div>

                <!-- Trust Box -->
                <div>
                    <h4 class="font-black uppercase text-indigo-950 mb-6 text-sm tracking-widest underline decoration-4 decoration-indigo-600 underline-offset-4">Compliance</h4>
                    <div class="p-4 border-4 border-indigo-950 bg-slate-50">
                        <p class="text-[10px] font-black text-indigo-950 uppercase leading-tight italic">
                            Guaranteed technical acceptance for Amazon KDP, IngramSpark, and Apple Books.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Bottom Bar -->
            <div class="pt-8 border-t-4 border-indigo-950 flex flex-col md:flex-row justify-between items-center gap-6">
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest">© 2024 ManuscriptPro. No more rejection emails.</p>
                <div class="flex items-center gap-4">
                    <span class="text-[10px] font-black text-slate-400 uppercase">Secure Checkout via</span>
                    <img src="https://upload.wikimedia.org/wikipedia/commons/e/ed/Paystack_Logo.png" alt="Paystack" class="h-4 opacity-50 grayscale hover:grayscale-0 transition-all">
                </div>
            </div>
        </div>
    </footer>

    <!-- WhatsApp Support Sticker -->
    <a href="https://wa.me/2349155975173" target="_blank" class="fixed bottom-8 right-8 z-[100] flex items-center space-x-3 bg-white px-5 py-3 sketch-card-dark group hover:bg-green-50 transition-colors">
